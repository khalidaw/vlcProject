...
#define PACKAGE_STRING "vlc 2.1.6"
...
#define VERSION_MESSAGE "2.1.6 Rincewind"

/* compiler */
#define VLC_COMPILER "gcc version 4.8.4 (Ubuntu 4.8.4-2ubuntu1~14.04)"

/* user who ran configure */
#define VLC_COMPILE_BY "adam"

/* host which ran configure */
#define VLC_COMPILE_HOST "adam-VirtualBox"
