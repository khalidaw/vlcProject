...
public:
    ...
    void setupUi(QWidget *SPrefsInterface)
    {
        ...
        SPrefsInterface->resize(686, 656);
        ...
        artFetcher = new QComboBox(OneInterfaceBox);
        artFetcher->setObjectName(QString::fromUtf8("artFetcher"));

        gridLayout_2->addWidget(artFetcher, 4, 1, 1, 1);

        sqlMLbtn = new QPushButton(OneInterfaceBox);
        sqlMLbtn->setObjectName(QString::fromUtf8("sqlMLbtn"));

        gridLayout_2->addWidget(sqlMLbtn, 5, 0, 1, 1);
        ...
        QWidget::setTabOrder(playPauseBox, artFetcher);
        QWidget::setTabOrder(artFetcher, sqlMLbtn);
        QWidget::setTabOrder(sqlMLbtn, updatesBox);
